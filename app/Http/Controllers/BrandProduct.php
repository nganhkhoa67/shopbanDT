...
class BrandProduct extends Controller
{
    ...
    public function unactive_brand_product($brand_product_id){
    	...
    	Session::put('message','Không kích hoạt thuơng hiệu sản phẩm thành công');
    ...
    public function delete_brand_product($brand_product_id){
        ...
        Session::put('message','Xóa nhật thương hiệu sản phẩm thành công');
        return Redirect::to('all-brand-product');
    ...
    public function show_brand_home($brand_id){
        ...
        $brand_by_id = DB::table('tbl_product')->join('tbl_brand_product','tbl_product.brand_id','=','tbl_brand_product.brand_id')->where('tbl_product.brand_id',$brand_id)->get();
         ...
         $brand_name = DB::table('tbl_brand_product')->where('tbl_brand_product.brand_id',$brand_id)->limit(1)->
            get();
